...
typography:
  ...
  telemetry:{ fontFamily: "JetBrains Mono", cqw: 1.1, weight: 500, tracking: "0.04em" }
...
- **Fonts** — **Space Grotesk** for titles/headings; **JetBrains Mono** for telemetry, coordinates, timestamps, distances. Ignore IBM Plex Mono / Barlow names in the preset prose.
- **Weights** — ships `{400, 500, 600, 700}` only.
- **Colors** — use the frontmatter hex. This film's DESIGN.md is the visual-identity source of truth: void black `#05070D`, deep navy `#0B1426`, bone white `#E8EEF7`, ignition orange `#FF6B35`, telemetry cyan `#4FC3F7`, lunar gold `#FFD166`.
- **Overrides vs Broadside prose** — ARTEMIS II may be uppercase; cyan and gold are allowed as data/hero accents; captions may use a subtle drop shadow; no full-screen linear gradients.
...
@font-face{font-family:"JetBrains Mono";font-weight:500;font-style:normal;font-display:block;src:url("assets/fonts/JetBrainsMono-500.woff2") format("woff2");}
@font-face{font-family:"JetBrains Mono";font-weight:700;font-style:normal;font-display:block;src:url("assets/fonts/JetBrainsMono-700.woff2") format("woff2");}
...
@font-face{font-family:"Space Grotesk";font-weight:600;font-style:normal;font-display:block;src:url("assets/fonts/SpaceGrotesk-600.woff2") format("woff2");}
