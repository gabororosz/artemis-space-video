...
- Add a TTS narration track using the hyperframes-cli skill with voice
  "bf_emma" or equivalent authoritative documentary voice. Captions synced
  per-word, bottom-center, bone-white on void black with subtle drop shadow.